...
# (name, age, msg)
# my_info = {'name' : '김보민', 'age': 26, 'msg' : 'hihihihih'}
...
# btc_opening_prince = coin['BTC']['opening_price']
# xrp_opening_prince = coin['XRP']['opening_price']
# total = float(btc_opening_prince) + float(xrp_opening_prince)
# print(total)
...
a=movie['movieInfo']['directors']
print(a[0]['peopleNmEn'])

# 3. 다음 movie의 배우의 인원을 출력하시오.
actornum=movie['movieInfo']['actors']
print(len(actornum))